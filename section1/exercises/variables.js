...
// log that variable to the console.
var admissionsRejection = 'Harry Potter must not return to Hogwarts!';
console.log(admissionsRejection);
...
//Response: I think the specific variable names made it easy to choose which data type to use. i.e. it makes sense to response to numberOfPets with a number.
