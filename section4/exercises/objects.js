...
*/ var cesaresEmail = {
      to: "Cesare Gallo",
      from: "Nick S.",
      sendersEmailAddress: "nick@votr.com",
      subject: "VOTR Fall League Registration",
      time: 1630,
      date: 08042021
};
...
var cesaresEmail = [ {
      to: "Cesare Gallo",
      from: "Barre Forte LoHi",
      sendersEmailAddress: "business341019@mindbodyonline.com",
      subject: "Barre Forte LoHi Reservation for Barre Forte - IN STUDIO on 8/4/21 at 12PM",
      time: 1141,
      date: 08042021
 },
 {
      to: "Cesare Gallo",
      from: "Veto Airedales",
      sendersEmailAddress: "vetoairedales@gmail.com",
      subject: "Re: Welsh Terrier",
      time: 1106,
      date: 08042021
},
{
      to: "Cesare Gallo",
      from: "Venmo",
      sendersEmailAddress: "venmo@venmo.com",
      subject: "Christopher Gallo commented on a payment between you and Christopher Gallo",
      time: 0605,
      date: 07312021
}
]

console.log(cesaresEmail);
console.log(cesaresEmail[0]); //0-2
