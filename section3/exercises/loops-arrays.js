...
var animals = ["Zebra", "Giraffe", "Elephant", "Tiger"];
...
var foods = ["strawberries", "bacon", "bagels", "peanut butter", "whipped cream", "chicken"];
...
var numbers = [3, 4, 5, 7, 8, 10];

for (var i = 0; i < numbers.length; i++) {
  numbers[i] = numbers[i] * 2;
  console.log(numbers[i] + " is the product");
}
